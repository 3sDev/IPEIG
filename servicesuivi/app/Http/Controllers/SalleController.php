...
class SalleController extends Controller
{
    ...
    {
        $response2 = Http::get($this->getUrlServer().'/getAllDataFromSalleEmplois');
        $salleEmplois = json_decode($response2);

        return view('salle.day-disponible', ['salleEmplois' => $salleEmplois]);
    }
    ...
    public function salleDisponibiliteByDay(Request $request)
    {
        ...
        'Salle24' => $Salle24, 'Salle25' => $Salle25, 'dateAbs' => $dateAbs, 'seanceAbs' => $seanceAbs, 'rattrapages' => $rattrapages]);
    }
