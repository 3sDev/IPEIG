...
//Liste copie zéro PFE routes
Route::get('copiezero',   [SoutenanceController::class, 'encadrement']);
//Soutenances
Route::get('soutenances',       [SoutenanceController::class, 'index']);
Route::resource('/soutenances', SoutenanceController::class);
Route::get('getStudent',        [SoutenanceController::class, 'getStudent'])->name('getStudent');
Route::post('liste-soutenance', [SoutenanceController::class, 'listeSouteances']);
// Route::get('show-pfe/{id}',         [PfeController::class, 'show']);
Route::get('show-demandePFE/{id}',     [SoutenanceController::class, 'show']);
Route::get('show-affectationPFE/{id}', [SoutenanceController::class, 'showAffectation']);
Route::get('show-affectationBinome/{id}/{binome}',[SoutenanceController::class, 'showAffectationBinome']);
Route::get('edit-soutenance/{id}',     [SoutenanceController::class, 'edit']);
Route::get('details-soutenance/{id}',  [SoutenanceController::class, 'detailSoutenance']);
Route::put('update-soutenance/{id}',   [SoutenanceController::class, 'updateSoutenance']);
Route::put('update-pfeDirection/{id}', [SoutenanceController::class, 'updatePFE']);
Route::put('update-proposition/{id}',  [SoutenanceController::class, 'updateProposition']);
Route::put('update-attestation/{id}',  [SoutenanceController::class, 'updateAttestation']);
Route::put('update-rapport/{id}',      [SoutenanceController::class, 'updateRapport']);
Route::get('delete-pfeDirection/{id}', [SoutenanceController::class, 'destroy']);
