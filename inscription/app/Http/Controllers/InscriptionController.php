...
class InscriptionController extends Controller
{
    ...
    public function verification(Request $request)
    {
        ...
        if ($student === null) {
            return redirect('login-verify')->with('student', $student)->with('successMsg','Student is connected .');
        }
        else {
            //return $student;
    ...
    public function storeNew(Request $request)
    {
        ...
        $student = Student::where('cin', '=', $cinVerif)->first();
        ...
        if ($request->input('type_inscription') == '') {
            $typeInscription = 'جديد';
        }
        else {
            $typeInscription = $request->input('type_inscription');
        }
