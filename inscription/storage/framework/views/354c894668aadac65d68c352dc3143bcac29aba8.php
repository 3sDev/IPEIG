 ...
 <?php $__env->startSection('title', 'Inscription Universitaire'); ?>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <center>
                        <a class="titleToLogin" href="<?php echo e(url('#')); ?>" class="btn btn-primary text-center"> 
                    ...
                    <a href="<?php echo e(url('login')); ?>" class="btn btn-secondary text-left"><i class="fa fa-arrow-left" aria-hidden="true"></i></a>
                </div>
                <!-- /.card-header -->
                <div class="card-body">

                    <form action="<?php echo e(url('inscription-new')); ?>" id="regForm" method="POST" onsubmit="return confirm('Confirmation!')" class="register-wizard-box" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
    ...
    <div class="col-md-12">
        <div class="row">
            ...
            <div class="form-group col-md-8">
                <div id="">
                    <label class="labelright">Numéro de passeport pour l'étudiant étranger*  / رقم بطاقة التعريف الوطنية بالنسبة للطالب التونسي</label>
                    <input type="text" id="cin" class="form-control" name="cin" placeholder="" oninput="this.className = ''">
                </div>
            </div>
            <div class="form-group col-md-4">
    ...
    <div class="col-md-12">
        <div class="row">
            ...
            <div class="form-group col-md-6">
                ...
                <p><input type="date" class="form-control" id="ddn" name="ddn" min="1900-01-01" max="2004-01-01" oninput="this.className = ''" ></p>
            </div>
        </div>
    </div>
</div>
...
<!-- Etape 13 -->
<div class="tab">
    <h5>Institut Supérieur des Sciences Appliquées et de Technologies de Gafsa</h5>
    <h4>المعهد العالي للعلوم التطبيقية والتكنولوجيا بقفصة</h4>
    <br><br>
    <div class="col-md-12">
        <div class="row">
            <div class="form-group col-md-6">
            ...
            <div class="form-group col-md-6">
                ...
                <select name="niveau" id="niveau" class="form-control" data-dependent="niveau" required>
                    ...
                    <option value="سنة أولى ماجستير مهني">سنة أولى ماجستير مهني</option>
                    <option value="سنة ثانية ماجستير مهني">سنة ثانية ماجستير مهني</option>
                    <option value="سنة أولى ماجستير بحث">سنة أولى ماجستير بحث</option>
                    <option value="سنة ثانية ماجستير بحث">سنة ثانية ماجستير بحث</option>
                  </select>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('adminlayoutenseignant.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/webroot/IPEIG/inscription/resources/views/auth/inscription-nouveau.blade.php ENDPATH**/ ?>