                        ...
                        {{-- @method('PUT') --}}
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input readonly type="text" name="subjectLabel" value="{{ $matiereElement->subjectLabel }}" class="form-control" required>
                                </div>
                                <div class="col-md-3">
                                    <label for="">Type matière</label>
                                    <select name="description" id="" class="form-control" required readonly>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <select name="semestre" id="" class="form-control" readonly>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <label for="">Volume horaire</label readonly>
                                    <input readonly type="text" name="volume" value="{{ $matiereElement->volume }}" class="form-control">
                                </div>
                                <div class="col-md-6">
