                ...
                <div class="row">
                  <div class="col-lg-3 col-6">
                    ...
                    <div class="small-box bg-success">
                      <div class="inner">
                        <h3><?php echo e($studentActive); ?>/<?php echo e($allStudents); ?></h3>
                      ...
                      <a href="<?php echo e(url('students')); ?>" class="small-box-footer">Voir Plus <i class="fas fa-arrow-circle-right"></i></a>
                    </div>
                  </div>
                  <!-- ./col -->
                  <div class="col-lg-3 col-6">
                    ...
                    <div class="small-box bg-danger">
                      <div class="inner">
                        <h3><?php echo e($studentNoActive); ?><sup style="font-size: 20px"></sup></h3>
                  ...
                  <div class="col-lg-3 col-6">
                    ...
                    <div class="small-box bg-info">
                      <div class="inner">
                        <h3><?php echo e($studentRetrait); ?></h3>
                  ...
                  <div class="col-lg-3 col-6">
                    ...
                    <div class="small-box bg-secondary">
                      <div class="inner">
                        <h3><?php echo e($studentMutation); ?></h3>
                ...
                <div class="row">
                  <div class="col-lg-3 col-6">
                    ...
                    <div class="small-box bg-warning">
                      <div class="inner">
                        <h3><?php echo e($studentDesactive); ?></h3>
                  ...
                  <div class="col-lg-3 col-6">
                    ...
                    <div class="small-box bg-gradient-dark">
                      <div class="inner">
                        <h3><?php echo e($studentDemandeStatut); ?>/<?php echo e($studentAllDemandes); ?></h3>
                      ...
                      <a href="<?php echo e(url('demandestudent')); ?>" class="small-box-footer">Voir Plus <i class="fas fa-arrow-circle-right"></i></a>
                    </div>
                  </div>
                  <!-- ./col -->
                  <div class="col-lg-3 col-6">
                    ...
                    <div class="small-box bg-gradient-maroon">
                      <div class="inner">
                        <h3><?php echo e($studentReclamationStatut); ?>/<?php echo e($studentAllReclamations); ?></h3>
                      ...
                      <a href="<?php echo e(url('reclamations')); ?>" class="small-box-footer">Voir Plus <i class="fas fa-arrow-circle-right"></i></a>
                    </div>
                  </div>
                  <!-- ./col -->
                  <div class="col-lg-3 col-6">
...
<?php echo $__env->make('adminlayoutscolarite.layoutdatatable', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/webroot/ENIGA/servicescolarite/resources/views/dashboard.blade.php ENDPATH**/ ?>