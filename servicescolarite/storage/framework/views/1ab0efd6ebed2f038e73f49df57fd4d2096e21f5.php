                            ...
                            <td>
                                <div class="filter-container p-0 row">
                                    <div class="filtr-item col-sm-2" data-category="3, 4" data-sort="red sample">
                                        ...
                                        <img class="img-circle" src=<?php echo e(asset($upload.'/avis/images/'.$avisElement->image)); ?> width="60px" height="60px" />
                                        </a>
                                    </div>
                                </div>  
                            </td>
...
<?php echo $__env->make('adminlayoutscolarite.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/webroot/ENIGA/servicescolarite/resources/views/avis/index.blade.php ENDPATH**/ ?>