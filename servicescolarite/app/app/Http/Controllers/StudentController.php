...
class StudentController extends Controller
{
    ...
    public function create()
    {
      ...
      $EtudiantEtat=EtudiantEtat::all();
      $EtudiantInscription=EtudiantInscription::all();
        return view('student.create', ['classes' => $classes,'EtudiantEtat'=>$EtudiantEtat,'EtudiantInscription'=>$EtudiantInscription]);
    }
    ...
    public function show($id)
    {
      ...
      $response6 = Http::get($this->getUrlServer().'/matieres');
        $matieres = json_decode($response6);   
               $response7 = Http::get($this->getUrlServer().'/teachers');
        $teachers = json_decode($response7);   
        return view('student.show', ['profiles' => $profiles, 'demandestudents' => $demandestudents,
        'attendancestudents' => $attendancestudents, 'reclamationstudent' => $reclamationstudent,'matieres'=>$matieres,'teachers'=>$teachers]);
    ...
    public function edit($id)
    {
        ...
        $EtudiantEtat=EtudiantEtat::all();
        $EtudiantInscription=EtudiantInscription::all();
        return view('student.edit', ['profiles' => $profiles, 'classes' => $classes,'EtudiantEtat'=>$EtudiantEtat,'EtudiantInscription'=>$EtudiantInscription]);
    }
