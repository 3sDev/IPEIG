...
@endforeach
@php
// Access the 'nom_etab_fr' property of the first element in the $variables array
 $nom_etab_fr = $variables[0]->nom_etab_fr;
 $nom_etab_ar = $variables[0]->nom_etab_ar;
 $splitResult_fr = explode('  ', $nom_etab_fr); 
 $splitResult_ar = explode('   ', $nom_etab_ar); 
@endphp
<div id="printme" class="container d-flex justify-content-center">
    <div class="row">
        <div class="col-md-12">
                ...
                <div class="container invoice">
                    <div class="invoice-body">
                                ...
                                <table width="100%">
                                    <tr  align="center" style="margin-right:10%;">
                                        ...
                                        <td width="45%"><img src="
                                          ...
                                          {{asset($upload.'/variables/'.$variables[0]->logo) }}" width="60px" alt="issat"><br></td>
                                    ...
                                    <tr align="center">
                                        ...
                                        <td></td>
                                        <td>
                                            <SPAN class="headerText">{{$variables[0]->nom_universite_fr}}</SPAN><BR>
                                            <SPAN class="headerText">@foreach($splitResult_fr as $part)
                                            {{ $part }}<br>
                                              @endforeach</span><BR>
                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12">
                                            ...
                                            <span>Le Directeur de l'{{$variables[0]->nom_etab_fr}}  atteste que</span><br><br>
                                            @else
                                                <span>Le secrétaire général de l'{{$variables[0]->nom_etab_fr}}  atteste que</span><br><br>
                                            @endif
                                            ...
                                            @endif                                            <span>Identifiant unique : </span> <label>{{ $demand->teacher->matricule }}</label><br>
                                            <span>Carte d'Identité Nationale : </span> <label>{{ $demand->teacher->cin }}</label><br>
                                            <span>Exerce à {{$variables[0]->directeur_fr}}  en qualité de :</span>
                                            <center>
                                            ...
                                            <div class="signature">
                                                <center>
                                                    <br>
                                                    <span>{{$variables[0]->place_fr}} le {{date('Y-m-d', strtotime($demand->created_at))}}</span><br>
                                                    @if ($signature == 'Directeur')
                        ...
                        <div class="invoice-footer">
                            <center>
                                <hr class="new1">
                                <span>Adresse :{{$variables[0]->adresse_fr}} </span><br>
                            <span  dir="auto">{{$variables[0]->fax}}</span><span>: الهاتف</span>   
                          <span dir="auto">{{$variables[0]->tel}}</span> <span>: الفاكس  </span>
                            </center>
                        </div>
                    </div>
                </div>
            ...
            <div class="container invoice" style="margin-top: -5%;">
                <div class="invoice-body">
                    <div class="row">
                        <div class="col-xs-12">
                            <table width="100%">
                                <tr  align="center" style="margin-right:10%;">
                                    <td width="45%"><img src="{{asset($upload.'/variables/'.$variables[0]->logo) }}" width="60px" alt="issat"><br></td>
                                    <td width="10%"></td>
                                    <td width="45%"><img src="{{ asset('upload/republiqueTunisienne.png') }}" width="50px" alt="republiqueTunisienne"><br></td>
                                </tr>
                                <tr align="center">
                                    <td>
                                        <SPAN class="headerText1Ar">{{$variables[0]->nom_universite_ar}} </SPAN><BR>
                                 	 <SPAN class="headerText">    @foreach($splitResult_ar as $part) {{ $part }}<br> @endforeach</span><BR>
                                    </td>
                                    <td></td>
                                    <td>
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    <div class="col-xs-11 labelAr" style="text-align:right !important;">
                                        ...
                                        @if ($signature == 'Directeur')
                                            <h4>يشهد (*) : مدير {{$variables[0]->nom_etab_ar}} أن</h4><br>
                                        @else
                                            <h4>يشهد (*) : الكاتب العام {{$variables[0]->nom_etab_ar}} أن</h4><br>
                                        @endif
                                        ...
                                        <table style="width: 100%; direction: rtl">
                                            ...
                                            @if ($demand->teacher->type_enseignant)
                                                <tr>
                                        ...
                                        <br>
                                        <p class="sousTitre">يعمل حاليا ب : {{$variables[0]->nom_etab_ar}} للسنة الجامعية : <b>{{$variables[0]->annee_universitaire}}</b></p>
                                        <p class="sousTitre">   .سلمت هذه الشهادة بطلب منه (ا) للإدلاء بها لدى من يهمه الأمر</p>
                                        
                                        <div class="signatureAr">
                                            <center>
                                                <span> حرر ب {{$variables[0]->place_ar}} في : {{date('Y-m-d', strtotime($demand->created_at))}}</span><br>
                        ...
                        <br>
                        <div class="invoice-footer">
                                <span>العنوان :{{$variables[0]->adresse_ar}} </span><br>
                           <span  dir="auto">{{$variables[0]->fax}}</span><span>: الهاتف</span>   
                          <span dir="auto">{{$variables[0]->tel}}</span> <span>: الفاكس  </span>
                        </div>
                    </div>
            ...
            <div class="container invoice">
                <div class="invoice-body">
                    <div class="row">
                        <div class="col-xs-12">
                            <table width="100%">
                                ...
                                <tr align="center">
                                    <td>
                                         <SPAN class="headerText1Ar">{{$variables[0]->nom_universite_ar}} </SPAN><BR>
                                        <SPAN class="headerText">    @foreach($splitResult_ar as $part)
                                            {{ $part }}<br>
                                              @endforeach</span><BR>
                                    </td>
                                    <td></td>
                        ...
                        <div class="col-xs-12">
                            <center class="titreDemandeOneLine"><h3><b>الى السيّد رئيس {{$variables[0]->nom_universite_ar}}</b> </h3></center>
                        </div>
                        <div class="col-xs-12">
                                    ...
                                    <div class="col-xs-11 labelAr" style="text-align:right !important;">
                                        <table style="width: 100%; direction: rtl">
                                            ...
                                            <tr>
                                                ...
                                                <td width="64%"><label>{{$variables[0]->nom_etab_ar}}</label></td>
                                            </tr>
                                            <tr>
                    ...
                    <div class="row">
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    <div class="col-xs-11 labelAr" style="text-align:right !important;">
                                        ...
                                        <br>
                                        <div class="signatureAdr">
                                            <span style="float:left; padding-left: 20% !important;"> {{$variables[0]->place_ar}} في : {{date('Y-m-d', strtotime($demand->created_at))}} <br>
                        ...
                        <div class="invoice-footer" style="text-align: right !important;">
                            ...
                            <table style="border-top: 2px solid black; direction: rtl; float: right;">
                                <tr>
                                    <td>
                                        <span>(*) يوجه مطلب الحصول على قائمة في الخدمات الى مصالح {{$variables[0]->nom_universite_ar}} عن طريق التسلسل الإداري.</span><br/>
                                ...
                                <div class="row">
                                    <div class="col-xs-11 labelAr" style="text-align:right !important;">
                                        ...
                                        <table style="width: 100%;">
                                            <tr>
                                                <td width="30%">
                                                    <span> {{$variables[0]->place_ar}} في : {{date('Y-m-d', strtotime($demand->created_at))}}</span><br>
