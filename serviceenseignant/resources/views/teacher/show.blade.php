        ...
        <div class="card-body box-profile">
          ...
          <ul class="list-group list-group-unbordered mb-3">
            <li class="list-group-item">
              <b>Poste</b> <a class="float-right">{{ $profile->type_enseignant }}</a>
            </li>
            <li class="list-group-item">
            ...
            <li class="list-group-item">
              <b>Satus Compte</b> <a class="float-right">{{ $profile->active }}</a>
            </li>
          </ul>
            ...
            <div class="row invoice-info">
              <div class="col-sm-6 invoice-col">
                ...
                <address>
                  ...
                  <strong>Lieu naissance :</strong> {{ $profile->gov }}<br>
                    <strong>Adresse :</strong> {{ $profile->rue_teacher }}<br>
                    <strong>Code Postale:</strong> {{ $profile->codepostal_teacher }}<br>
                        <strong>Nom Conjoint:</strong> {{ $profile->nom_garant }}<br>
                  <strong>Profession Conjoint:</strong> {{ $profile->profession_garant }}<br>
