...
class TeacherController extends Controller
{
    ...
    public function create()
    {
        ...
        $specialiteTeachers = json_decode($response); 
        $Enseignant = EnseignantEtat::all();
         $Enseignantgrade = EnseignantGrade::all();
      $EnseignantPoste=EnseignantPoste::all();
        return view('teacher.create', ['departements' => $departements,'specialiteTeachers'=>$specialiteTeachers,'Enseignant'=> $Enseignant,'Enseignantgrade'=> $Enseignantgrade,'EnseignantPoste'=>$EnseignantPoste]);
    }
    ...
    $response = Http::get($this->getUrlServer().'/specialites');
       ...
       $EnseignantPoste=EnseignantPoste::all();
        ...
        return view('teacher.edit', ['profiles' => $profiles, 'departements' => $departements,'specialiteTeachers'=>$specialiteTeachers,'Enseignant'=> $Enseignant,'Enseignantgrade'=> $Enseignantgrade,'EnseignantPoste'=>$EnseignantPoste]);
    }
