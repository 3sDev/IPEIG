                  ...
                  <div class="row">
                    <div class="col-lg-3 col-6">
                      ...
                      <div class="small-box bg-info">
                        <div class="inner">
                          <h3><?php echo e($demandeEnCours); ?>/<?php echo e($allDemands); ?></h3>
                        ...
                        <a href="<?php echo e(url('demandeteacher')); ?>" class="small-box-footer">Voir Plus <i class="fas fa-arrow-circle-right"></i></a>
                      </div>
                    </div>
                    <!-- ./col -->
                    <div class="col-lg-3 col-6">
                      ...
                      <div class="small-box bg-success">
                        <div class="inner">
                          <h3><?php echo e($reclamationEnCours); ?>/<?php echo e($allReclamations); ?></h3>
                    ...
                    <div class="col-lg-3 col-6">
                      ...
                      <div class="small-box bg-warning">
                        ...
                        <a href="<?php echo e(url('teachers')); ?>" class="small-box-footer">Voir Plus <i class="fas fa-arrow-circle-right"></i></a>
                      </div>
                    </div>
                    <!-- ./col -->
                    <div class="col-lg-3 col-6">
                ...
                <div class="row">
                  <div class="col-lg-3 col-6">
                    ...
                    <div class="small-box bg-gradient-dark">
                      <div class="inner">
                        <h3><?php echo e($teacherPermanant); ?></h3>
                  ...
                  <div class="col-lg-3 col-6">
                    ...
                    <div class="small-box bg-gradient-maroon">
                      <div class="inner">
                        <h3><?php echo e($teacherContractuel); ?></h3>
                  ...
                  <div class="col-lg-3 col-6">
                    ...
                    <div class="small-box bg-gradient-cyan">
                      <div class="inner">
                        <h3><?php echo e($teacherVacataire); ?></h3>
                  ...
                  <div class="col-lg-3 col-6">
                    ...
                    <div class="small-box bg-gradient-teal">
                      <div class="inner">
                        <h3><?php echo e($teacherExpert); ?></h3>
...
<?php echo $__env->make('adminlayoutenseignant.layoutdatatable', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/webroot/ENIGA/serviceenseignant/resources/views/dashboard.blade.php ENDPATH**/ ?>