...
class Student extends Model
{
    ...
    {  
        return $this->belongsToMany('App\Models\Examen','examen_students','examen_id','student_id');
    }

    public function devoirs()
    {  
        return $this->belongsToMany('App\Models\Devoir','devoir_students','devoir_id','student_id');
    }
