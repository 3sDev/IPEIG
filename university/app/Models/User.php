...
class User extends Authenticatable
{
    ...
    // public function messageServiceUser()
    // {
    //     return $this->belongsToMany('App\Models\MessageServiceUser', 'message_services', 'user_sender_id', 'user_receiver_id');
    //     //return $this->belongsToMany('App\Models\MessageService', 'message_services', 'user_sender_id', 'user_receiver_id');
    // }
