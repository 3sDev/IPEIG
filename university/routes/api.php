...
use App\Http\Controllers\Personnels\PersonnelEatController;
//Emploi de temps
...
use App\Http\Controllers\EnseignantEtatController;
/*
|--------------------------------------------------------------------------
| API Routes
|--------------------------------------------------------------------------
...
Route::post('verify-by-cin', [StudentController::class, 'cin_verification']);
...
Route::put('updateSignatureChefDep/{id}',  [DepartementController::class, 'updateSignatureChefDep']);
Route::put('updateimage',        [VariableController::class, 'updateimage']);
...
Route::get('all-classes-terminal', [ClasseController::class, 'getAllClassesTerminal']);
...
Route::get('countAllCourriersEntrants', [CourrierEntrantController::class, 'countAllCourriersEntrants']);
Route::get('entrant/{id}',              [CourrierEntrantController::class, 'index']);
Route::post('entrants',                 [CourrierEntrantController::class, 'store']);
Route::get('getAllCourriersEntrants',   [CourrierEntrantController::class, 'getAllCourriersEntrants']);
Route::put('update-entrant/{id}',       [CourrierEntrantController::class, 'update']);
Route::put('update-fileEntrant/{id}',   [CourrierEntrantController::class, 'updateFileEntrant']);
Route::delete('delete-entrant/{id}',    [CourrierEntrantController::class, 'destroy']);
//Courriers Sortants Routes 
Route::get('countAllCourriersSortants', [CourrierSortantController::class, 'countAllCourriersSortants']);
Route::get('sortant/{id}',              [CourrierSortantController::class, 'index']);
Route::post('sortants',                 [CourrierSortantController::class, 'store']);
Route::get('getAllCourriersSortants',   [CourrierSortantController::class, 'getAllCourriersSortants']);
Route::put('update-sortant/{id}',       [CourrierSortantController::class, 'update']);
Route::put('update-fileSortant/{id}',   [CourrierSortantController::class, 'updateFileSortant']);
Route::delete('delete-sortant/{id}',    [CourrierSortantController::class, 'destroy']);
...
Route::get('getAllDemandesFromStudentByCategoryStageCopie0', [DemandeStudentController::class, 'getAllDemandesFromStudentByCategoryStageCopie0']);
...
Route::put('updateCopieZero/{id}', [DemandeStudentController::class, 'storeCopieZero']);
Route::put('updateSoutenanceDashboard/{id}', [DemandeStudentController::class, 'updateSoutenanceDashboard']);
Route::put('updateSoutenanceApp/{id}', [DemandeStudentController::class, 'updateSoutenanceApp']);
Route::get('getAllDemandesByIdStudentAndCategory/{id}', [DemandeStudentController::class, 'getAllDemandesByIdStudentAndCategory']);
Route::get('getAllDemandesByIdStudentAndCategoryAndClasse/{id}', [DemandeStudentController::class, 'getAllDemandesByIdStudentAndCategoryAndClasse']);
Route::get('getAllDemandesFromIdEncadrant/{id}', [DemandeStudentController::class, 'getAllDemandesFromIdEncadrant']);
Route::get('getAllDemandesFromIdMembreJury/{id}', [DemandeStudentController::class, 'getAllDemandesFromIdMembreJury']);
...
Route::delete('deleteAttendanceStudent/{id}', [AttendanceController::class, 'destroy']);


Route::get('students-classes/{id}', [StudentController::class, 'getAllStudentsWithClasseFromIdClasse']);
Route::get('students-classesRandom/{id}', [StudentController::class, 'getAllStudentsWithClasseFromIdClasseRandom']);
...
Route::put('update-releveNote/{id}',  [StudentController::class, 'updateReleveNote']);
Route::put('update-Mutation/{id}',  [StudentController::class, 'updateMutation']);
Route::put('update-Sortie/{id}',  [StudentController::class, 'updateSortie']);
Route::put('update-Reorientation/{id}',  [StudentController::class, 'updateReorientation']);
Route::put('update-Reintegration/{id}',  [StudentController::class, 'updateReintegration']);
Route::put('update-DemandeEcrite/{id}',  [StudentController::class, 'updateDemandeEcrite']);
Route::put('update-recuPaimentComplet/{id}',  [StudentController::class, 'updaterecuPaimentComplet']);
...
//Examens Students Routes 
Route::post('examens',           [ExamenController::class, 'store']);
Route::post('addNotesExamens',   [ExamenController::class, 'storeExamen']);
Route::post('addNotesToStudentsByTeacher',   [ExamenController::class, 'addNotesToStudentsByTeacher']);
Route::get('examens/{id}',       [ExamenController::class, 'index']);
Route::get('getAllExamens',      [ExamenController::class, 'getAllExamens']);
Route::get('examenWithStudentsById/{id}',   [ExamenController::class, 'examenWithStudentsById']);
Route::get('getAllExamensByIdTeacher/{id}', [ExamenController::class, 'getAllExamensByIdTeacher']);
Route::get('getCountExamenTeacherByStatut/{statut}', [ExamenController::class, 'getCountExamenTeacherByStatut']);
Route::put('update-examen/{id}', [ExamenController::class, 'update']);
Route::delete('delete-examenNote/{id}', [ExamenController::class, 'destroy']);

//Devoirs Students Routes 
Route::post('devoirs',           [DevoirController::class, 'store']);
Route::post('addNotesDevoirs',   [DevoirController::class, 'storeDevoir']);
Route::get('devoirs/{id}',       [DevoirController::class, 'index']);
Route::get('getAllDevoirs',      [DevoirController::class, 'getAllDevoirs']);
Route::get('devoirWithStudentsById/{id}', [DevoirController::class, 'devoirWithStudentsById']);
Route::get('getAllDevoirsByIdTeacher/{id}', [DevoirController::class, 'getAllDevoirsByIdTeacher']);
Route::get('getCountDevoirTeacherByStatut/{statut}', [DevoirController::class, 'getCountDevoirTeacherByStatut']);
Route::put('update-devoir/{id}', [DevoirController::class, 'update']);
Route::delete('delete-devoirNote/{id}', [DevoirController::class, 'destroy']);
...
Route::put('updateSignatureChefDepartement', [VariableController::class, 'updateSignatureChefDepartement']);
Route::put('updateLogoVariable',        [VariableController::class, 'updateLogoVariable']);
Route::post('postePersonne',            [EnseignantEtatController::class, 'store']);
