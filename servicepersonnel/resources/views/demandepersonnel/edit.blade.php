            ...
            <div class="card-body">
                ...
                <form action="{{ url('show-demandepersonnel/'.$demand->id) }}" method="post" target="_blank">
                    ...
                    <div class="row">
                        ...
                        @if ($demand->type == 'شهادة عمل')
                        	...
                        	<div class="col-md-3" style="left: 1%;">
                               ...
                               <label for="">Raison de la demande:</label> {{$demand->raison}}</br>
                                          <label for="">Langue:</label> {{$demand->langue}}
                            </div>
                            <div class="col-md-3">
                        ...
                        @endif
                             @if ($demand->type == 'شهادة في الاجر')
                                <div class="col-md-3" style="left: 1%;">
                                          <label for="">Nombre de mois:</label> {{$demand->nombre_mois}}</br>
                                          <label for="">Langue:</label> {{$demand->langue}}
                                 </div>
                  ...
                  @if ($demand->type == 'حجز الاداء على الدخل')
                                <div class="col-md-3" style="left: 1%;">
                                          <label for="">Année:</label> {{$demand->years}}</br>
                  ...
                  @if ($demand->type == 'حصول على قائمة في الخدمات')
                            ...
                            @endif 
                                ...
                                <div class="col-md-3" style="left: 1%;">
                                        <label for="">Date de Reprise de Travail:</label> {{$demand->dateRepriseTravail	}}
                                        <label for="">Type de vacance:</label> {{$demand->VacanceType}}
                                        <label for="">Date de Début de vacance:</label> {{$demand->date_debut_vacance}}
                                        <label for="">Date de Fin de vacance:</label> {{$demand->date_fin_vacance}}
                        ...
                        <div class="col-md-6">
                            ...
                            <div id="banner">
                                ...
                                <label for="">Nom Formation:</label> {{$demand->nom_formation}}</br>
                                <label for="">Date début:</label> {{$demand->date_debut_formation}}</br>
                                <label for="">Date Fin:</label> {{$demand->date_fin_formation}}</br>
                                <label for="">Lieu:</label> {{$demand->lieu_formation}}</br>
                                <label for="">Volume:</label> {{$demand->volume_formation}}</br>
                                <label for="">Structure de Formation:</label> {{$demand->structure_formation}}</br>
                                <label for="">Prix:</label> {{$demand->prix_formation	}}</br>
                                @endif
                                @if ($demand->file_rib)
                                    <div class="inline-block">
                              		  ...
                              		  <label for="">Numéro ancien compte (RIB):</label> {{$demand->ancien_compte}}</br>
             					 <label for="">Numéro Nouveau compte (RIB):</label> {{$demand->nouveau_compte}}</br>
                                @endif
