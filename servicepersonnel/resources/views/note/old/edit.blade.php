                ...
                @foreach ($notes as $element)
                    ...
                    <div class="row">
                        <div class="col-md-4" style="color: orangered">
                            ...
                            <input type="text" name="note3" class="form-control" value="{{ $element->note3 }}">
                        </div>
                        <div class="col-md-4" style="color: orangered">
                            <label class="labelright">كيفية العمل</label>
                            <input type="text" name="note2" class="form-control" value="{{ $element->note2 }}">
                        </div>
                        <div class="col-md-4" style="color: orangered">
                            <label class="labelright">كمية العمل</label>
                            <input type="text" name="note1" class="form-control" value="{{ $element->note1 }}">
                        </div>
                    </div>
                    <br><br>
                    <div class="row">
                        ...
                        <div class="col-md-4" style="color: orangered">
                            ...
                            <input type="text" name="note_global" class="form-control" value="{{ $element->note_global }}">
                        </div>
                        <div class="col-md-4" style="color: orangered">
                            <label class="labelright">المثابرة</label>
                            <input type="text" name="note4" class="form-control" value="{{ $element->note4 }}">
                        </div>
                    </div>
                    <br><br>
                    <center>
