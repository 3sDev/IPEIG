            ...
            <div class="card">
                ...
                <table id="example1" class="table table-bordered table-striped text-right">
                    ...
                    <tr>
                        ...
                        <td><span>{{ $element->conge_maladie ?? 'None' }} </span></td> 
                        <td><span>{{ $element->conge_compensatoire ?? 'None' }} </span></td> 
                        <td><span>{{ $element->conge_exceptionnel ?? 'None' }} </span></td> 
                        <td><span>{{ $element->conge_annual ?? 'None' }} </span></td> 
                        <td><span>{{ $element->annee ?? 'None' }}  </span></td> 
