                    ...
                    <table width="100%">
                        ...
                        <tr align="center">
                            <td>
                                ...
                                <SPAN class="headerText1Ar">المعهد العالي للعلوم </SPAN><BR>
                                <SPAN class="headerTextAr">التطبيقية و التكنلوجيا بقفصة</SPAN>
                            </td>
                            <td></td>
                            <td>
                              ...
                              @foreach ($personnels as $element)
                                <table id="page" style="width: 100%; direction: rtl">
                                    ...
                                    <tr>
                                        ...
                                        <td width="64%"><label>المعهد العالي للعلوم التطبيقية و التكنلوجيا بقفصة</label></td>
                                    </tr>
                                    <tr>
                                      ...
                                      <td>
                                        ...
                                        @endif
                                             <label>{{ ' من     '.$demand->date_debut }}</label>
                                    
                                          <label>{{ ' الى     ' .$demand->date_fin}}</label>
                                      </td>
