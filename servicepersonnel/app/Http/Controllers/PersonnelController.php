...
class PersonnelController extends Controller
{
    ...
    public function create()
    {
        ...
        $grades = json_decode($response3); 
         $Personnel = PesonnelEtat::all();

        return view('personnel.create', ['fonctions' => $fonctions, 'categories' => $categories, 'grades' => $grades,'Personnel'=>$Personnel]);
    }
    ...
    public function edit($id)
    {
        ...
        $Personnel = PesonnelEtat::all();
        return view('personnel.edit', ['profiles' => $profiles, 'fonctions' => $fonctions, 'categories' => $categories, 'grades' => $grades,'Personnel'=>$Personnel]);
    }
