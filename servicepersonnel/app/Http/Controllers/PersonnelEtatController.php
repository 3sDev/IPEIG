...
use App\Models\PesonnelEtat;

class PersonnelEtatController extends Controller
{
    ...
    {
        $Enseignants = PesonnelEtat::all();

    // Pass the $posts variable to the view using compact
    return view('personnelEtat.show', compact('Enseignants'));
    ...
    {
        return view('personnelEtat.create');
    }
    ...
    public function store(Request $request)
    {
      ...
      /*	$etat = new PesonnelEtat;
        ...
        return redirect('personnelEtat')->with('message', 'Etat personnel  a été ajouté avec succés');*/
    }
    ...
    public function destroy($id)
    {
       ...
       $Enseignants = PesonnelEtat::find($id);
    ...
    if ($Enseignants) {
       ...
       return redirect()->back()->with('message', 'Etat personnel a été supprimé avec succés');
    }
}
