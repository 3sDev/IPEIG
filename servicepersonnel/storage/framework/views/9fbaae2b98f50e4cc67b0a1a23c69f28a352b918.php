<?php $__env->startSection('title', 'Ajouter personnel'); ?>
        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-header">
                    <a href="<?php echo e(url('personnels')); ?>" class="btn btn-danger float-left">Back</a>
                </div>
                <div class="card-body">
                    <form action="<?php echo e(url('personnels')); ?>" method="POST" enctype="multipart/form-data" onsubmit="return confirm('Êtes-vous sûr d\'ajouter cette donnée?')">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <select id="active" name="active" class="form-control" required>
                                    ...
                                    <?php $__currentLoopData = $Personnel; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $element): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                      <option value="<?php echo e($element->Etat_fr.' / '.$element->Etat_ar); ?>"><?php echo e($element->Etat_fr.' / '.$element->Etat_ar); ?></option>
                                      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <select id="poste" name="poste" class="form-control">
                                    ...
                                    <option value="" disabled>-----------------------------</option>
                              <option value=" " > </option>
                                    <?php $__currentLoopData = $fonctions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $element): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($element->label_fr.' / '.$element->label_ar); ?>"><?php echo e($element->label_fr.' / '.$element->label_ar); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <select id="grade" name="grade" class="form-control">
                                    ...
                                    <option value="" disabled>-----------------------------</option>
                                     <option value=" " > </option>                  
                                    <?php $__currentLoopData = $grades; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $element): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($element->label_fr.' / '.$element->label_ar); ?>"><?php echo e($element->label_fr.' / '.$element->label_ar); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('adminlayoutenseignant.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/webroot/ENIGA/servicepersonnel/resources/views/personnel/create.blade.php ENDPATH**/ ?>