...
class EnseignantEtatController extends Controller
{
    ...
    {
        $Enseignants = EnseignantEtat::all();

    // Pass the $posts variable to the view using compact
    return view('enseignantEtat.show', compact('Enseignants'));
    ...
    {
        return view('enseignantEtat.create');
    }
    ...
    public function store(Request $request)
    {
      	...
      	$etat = new EnseignantEtat;
        $etat->value = $request->input('value');
        $etat->Etat_fr = $request->input('Etat_fr');
        $etat->Etat_ar = $request->input('Etat_ar');
        $etat->save();
      
        return redirect('enseignantEtat')->with('message', 'enseignant Etat est ajouté avec succés');
    }
    ...
    public function destroy($id)
    {
       ...
       $Enseignants = EnseignantEtat::find($id);
    ...
    if ($Enseignants) {
       ...
       return redirect()->back()->with('message', 'Etat enseignant a été supprimé avec succés');
    }
}
