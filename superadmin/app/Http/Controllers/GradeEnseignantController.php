...
class GradeEnseignantController extends Controller
{
    ...
    {
      $Enseignants =  EnseignantGrade::all();

    // Pass the $posts variable to the view using compact
   return view('enseignantGrade.show', compact('Enseignants'));
    ...
    public function create()
    {
        ...
        return view('enseignantGrade.create');
    }
    ...
    public function store(Request $request)
    {
      	...
      	$etat = new EnseignantGrade;
        $etat->value = $request->input('value');
        $etat->Grade_fr= $request->input('Grade_fr');
        $etat->Grade_ar= $request->input('Grade_ar');
        $etat->save();
      
        return redirect('enseignantgrade')->with('message', 'enseignant grade est ajouté avec succés');
    }
    ...
    public function destroy($id)
    {
       ...
       $Enseignants = EnseignantGrade ::find($id);
    ...
    if ($Enseignants) {
       ...
       return redirect()->back()->with('message', 'Grade enseignant a été supprimé avec succés');
    }
}
