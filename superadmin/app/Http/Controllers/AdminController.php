...
class AdminController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.create', ['departements' => $departements,'teachers'=>$teachers,'Personnels'=>$Personnels]);
    }
    ...
    {
        $response = Http::get($this->getUrlServer().'/personne');
        $departements = json_decode($response); 
    ...
    public function updatePasswordAdmin(Request $request, $id)
    {
        ...
        if (Hash::check($currentPassword, $userPassword) && $newPassword == $confirmPassword) {
            $user->password = Hash::make($newPassword);
            $user->update();
