                            ...
                            <div class="col-lg-12" style="text-align:left !important;">
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-8">
                                            <a href="<?php echo e(url('etudiantInscription/create')); ?>" target="_blank" class="btn btn-success float-right">Ajouter</a><br><br>
                                            <table id="example1" class="table table-bordered table-striped">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php echo e($cat->Inscription_fr); ?></td>
                                                        <td><?php echo e($cat->Inscription_ar); ?></td>
                                                        
                                                        
                                                        <td class="text-center">
                                                            <form action="<?php echo e(route('etudiantInscription.destroy',$cat->id)); ?>" method="POST">
                                                               <?php echo csrf_field(); ?>
...
<?php echo $__env->make('adminlayoutenseignant.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/webroot/IPEIG/superadmin/resources/views/EtudiantInsc/show.blade.php ENDPATH**/ ?>