...
use App\Http\Controllers\PosteEnseignantController;
use App\Http\Controllers\GradeEnseignantController;
use App\Http\Controllers\EtudiantEtatController;
use App\Http\Controllers\EtudiantInscriptionController;
use App\Http\Controllers\PersonnelEtatController;
...
// Route::get('show-departements/{id}',   [DepartementController::class, 'show']);
// Route::get('edit-departements/{id}',   [DepartementController::class, 'edit']);
// Route::get('update-departements/{id}', [DepartementController::class, 'update']);
// Route::get('delete-departements/{id}', [DepartementController::class, 'destroy']);
...
Route::put('update-chefDep/{id}',          [DepartementController::class, 'updateSignatureChefDep']);
...
Route::put('logooVariable',   [VariableController::class, 'updateLogooVariable']);
...
Route::put('update-signChefDep',    [VariableController::class, 'updateSignatureChefDepartement']);
Route::put('update-image', [VariableController::class, 'updateimage']);
...
Route::resource('/enseignantEtat', EnseignantEtatController::class);
  Route::resource('/enseignantposte', PosteEnseignantController::class);
   Route::resource('/enseignantgrade', GradeEnseignantController::class);
  Route::resource('/etudiantEtat', EtudiantEtatController::class);
    Route::resource('/personnelEtat', PersonnelEtatController::class);
    Route::resource('/etudiantInscription', EtudiantInscriptionController::class);
//Route::get('AllPostePersonnels',    [PostePersonnelController::class, 'index']);
