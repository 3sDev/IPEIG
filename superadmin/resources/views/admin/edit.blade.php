            ...
            <div class="card">
                ...
                <div class="card-body">
                 ...
                 @method('PUT')
                    ...
                    <br><hr><br>
                    <center>
                        <h5 class="TitleOne">Changer le mot de passe ({{ $adminElement->name }})
                    </center>
                    <br><br>
            ...
            success: function(res) {
                ...
                if (res) {
                    ...
                    if (roleAdmin == 'Chef de département') {
                        $("#departement_id").append('<option value="" selected disabled>Selectionner Département</option>');
                        res.map(element=>{
                        $("#departement_id").append('<option value="'+element.id+'">' +element.departmentLabel+'</option>');
                        });
                    } else {
                        $("#departement_id").append('<option value="1">'+roleAdmin+'</option>');
                    }
                } 
