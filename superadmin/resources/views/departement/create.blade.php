                ...
                <form action="{{ url('departements') }}" method="POST" onsubmit="return confirm('Êtes-vous sûr d\'ajouter un département?')" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="nom_chef_dep" class="form-control">
                        </div>
                        <div class="col-md-6">
                            <label for="">Signature chef département</label>
                            <input type="file" name="signature_chef_dep" class="form-control" >
                        </div>
                    </div>
                    <br>
                    <div class="mb-3">
