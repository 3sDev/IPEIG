 ...
 @section('title', 'Gestion des états des enseignants')
 @section('contentPage')
                            ...
                            <div class="col-lg-12" style="text-align:left !important;">
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-8">
                                            <a href="{{ url('enseignantEtat/create') }}" target="_blank" class="btn btn-success float-right">Ajouter</a><br><br>
                                            <table id="example1" class="table table-bordered table-striped">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            <form action="{{ route('enseignantEtat.destroy',$cat->id) }}" method="POST">
                                                               @csrf
                                                              @method('DELETE')
