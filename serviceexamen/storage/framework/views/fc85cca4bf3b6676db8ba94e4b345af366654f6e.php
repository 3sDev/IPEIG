<?php $__env->startSection('title', 'Créer emploi des examens'); ?>
<?php $__env->startSection('contentPage'); ?>
    ...
    <div class="content-header">
        ...
        <div class="row mb-2">
            ...
            <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item"><a href="<?php echo e(url('emploi')); ?>">Liste des emploi des examens/Groupes</a></li>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-body">
                    <form action="<?php echo e(url('emploi-examen-student')); ?>" method="POST" onsubmit="return confirm('Êtes-vous sûr d\'ajouter cet emploi?')" enctype="multipart/form-data">
...
<?php echo $__env->make('adminlayoutscolarite.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/webroot/ENIGA/serviceexamen/resources/views/emploi_examen_student/create.blade.php ENDPATH**/ ?>