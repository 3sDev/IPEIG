        ...
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="<?php echo e(url('avisTeacher')); ?>" method="POST" enctype="multipart/form-data">
...
<?php echo $__env->make('adminlayoutscolarite.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/webroot/ENIGA/serviceexamen/resources/views/avis_teacher/create.blade.php ENDPATH**/ ?>