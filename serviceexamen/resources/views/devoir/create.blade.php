...
@section('contentPage')
    ...
    <div class="content-header">
        ...
        <div class="row mb-2">
            <div class="col-sm-6">
            <h1 class="m-0">Ajouter devoir pour un Groupe</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="{{ url('dashboard') }}">Dashboard</a></li>
                <li class="breadcrumb-item"><a href="{{ url('devoirs') }}">Liste des devoirs</a></li>
                <li class="breadcrumb-item active">Créer nouveau devoir</li>
            </ol>
            </div><!-- /.col -->
        </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="col-md-12">
                                    ...
                                    <input type="type_devoir" name="type_devoir" class="form-control">
                                </div>
                            </div>
                        </div>
                        <br><br>
...
$('#classes').change(function() {
    ...
    if (classeID) {
        ...
        $.ajax({
            type: "GET",
            url: "{{ url('getMatiereDevoir') }}?classe_id=" + classeID+"&semestre=" + semestre,
