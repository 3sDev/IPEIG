    ...
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <center>
                    <table id="example1" BORDERCOLOR="#ccc" style="padding-right:5px; table-layout:fixed; width:60% !important" class="table table-bordered table-striped">
                        <thead>
                            <tr>
                                <th width="20%">CIN</th>
                        ...
                        @foreach ($examens as $examen) 
                            @foreach ($codes as $item)
                                @if ($item->pivot->note == 'non autorisé')
                                        ...
                                        <form action="{{ url('modifierCodeStudentByIdCode/'.$item->pivot->id) }}" onsubmit="return confirm('Êtes-vous sûr de vouloir modifier ce code ?')">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <div class="input-group-append">
                                                    <input type="text" id="s" class="form-control" value="{{ $item->pivot->code }}" name="code" readonly style="width: 60% !important;">
                                                ...
                                                @else
                                                <div class="input-group-append">
                                                    <input type="text" id="s" class="form-control" value="{{ $item->pivot->code }}" name="code" required style="width: 60% !important;">
