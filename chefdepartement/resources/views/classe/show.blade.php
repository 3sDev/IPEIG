                                    ...
                                    <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                                      <div class="col-lg-12" style="text-align:left !important;" id="myPrint"> 
                                            <div class="form-group" style="background-color: white"><br>
                                              <h2 style="color: orangered; font-weight:bold; text-align:center">{{$classe->abbreviation}} <span style="color: rgb(117, 57, 36); font-weight: 400; font-size: 29px">(Semestre {{ $mySemestre }} )</span></h2><br>
                                              <div>
                                                <div> 
    ...
    function convertToImage() {
      ...
      html2canvas(document.getElementById("myPrint"), {
          onrendered: function(canvas) {
              ...
              result.innerHTML = '<a download="{{$classe->abbreviation.' - Semestre'.$mySemestre}}.jpeg" href="'+img+'">{{$classe->abbreviation.' - Semestre'.$mySemestre}}</a>';
              }
      });
    }        
    //click event
