                    ...
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            @foreach ($rattrapages as $rattrapage)
                                ...
                                @if (($rattrapage->statut=='En cours'))
                                <td align="center"><span class="demandEnvoyee">{{ $rattrapage->statut }}</span></td>
                                @endif
                                @if (($rattrapage->statut=='Accepté'))
                                <td align="center"><span class="demandTraitee">{{ $rattrapage->statut }}</span></td>
                                @endif
                                @if (($rattrapage->statut=='Réfusé'))
                                <td align="center"><span class="demandRefuse">{{ $rattrapage->statut }}</span></td>
                                @endif
