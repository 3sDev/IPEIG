                ...
                <div class="card-body">
                    ...
                    {{-- @method('PUT') --}}
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select name="semestre" class="form-control" required>
                                        <option value="{{ $pointage->semestre }}">S{{ $pointage->semestre }}</option>
                            ...
                            <div class="col-md-4">
                                <label for="">Date Pointage</label>
                                <input type="date" name="date_pointage" value="{{ $pointage->date_pointage }}" class="form-control" required>
                            </div>
                            <div class="col-md-4">
