        ...
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ url('update-attendance/'.$attendance->id) }}" onsubmit="return confirm('Êtes-vous sûr de modifier ces données?')">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <select id="heure_debut" name="heure_debut" class="form-control" required>
                                    <option value="{{ $attendance->heure_debut }}">{{ $attendance->heure_debut }}</option>
                                    <option value="" disabled>----------------------</option>
                            ...
                            <div class="col-md-4">
                                ...
                                <select id="heure_fin" name="heure_fin" class="form-control" required>
                                    <option value="{{ $attendance->heure_fin }}">{{ $attendance->heure_fin }}</option>
                                    <option value="" disabled>----------------------</option>
                                    <option value="10:00">10:00</option>
                                    {{-- <option value="10:05">10:05</option> --}}
                                    <option value="11:35">11:35</option>
