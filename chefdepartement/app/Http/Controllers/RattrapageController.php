...
class RattrapageController extends Controller
{
    ...
    public function create()
    {
        ...
        if (Auth::user()->departement_id == '1') {
            ...
            $teachers  = json_decode($response);  
            $response3 = Http::get($this->getUrlServer().'/classesWithDepartement/'.$departementAdmin);
    ...
    public function edit($id)
    {
        ...
        if (Auth::user()->departement_id == '1') {
            ...
            $response1 = Http::get($this->getUrlServer().'/teachersWithDepartement/'.$departementAdmin);
            $teachers = json_decode($response1); 
            $response3 = Http::get($this->getUrlServer().'/classesWithDepartement/'.$departementAdmin);
            $classes = json_decode($response3);
        }
