...
class TeacherController extends Controller
{
    ...
    public function affecter($id)
    {
        ...
        return view('teacher.affecter', ['teachers' => $teachers, 'matieres' => $matieres , 'matieresTeachers' => $matieresTeachers]);
    }

    public function disponibiliteSallesSeances($debut, $fin, $day, $type_seance)
    {
        $response = Http::get($this->getUrlServer().'/tous-salles-disponible-seances/'.$debut.'/'.$fin.'/'.$day.'/'.$type_seance);
        $result = json_decode($response);
        return response()->json($result);
    }
