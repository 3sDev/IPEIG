...
//Route::get('show-departement/{id}', [DepartementController::class, 'show']);
...
Route::get('disponibiliteSallesSeances/{debut}/{fin}/{day}/{type_seance}', [TeacherController::class, 'disponibiliteSallesSeances']);
