...
@section('title', 'Détails Courier Sortant')
@section('contentPage')
...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0">Détails Courier Sortant</h1>
      </div><!-- /.col -->
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          <li class="breadcrumb-item"><a href="{{ url('dashboard') }}">Dashboard</a></li>
          <li class="breadcrumb-item"><a href="{{ url('sortants') }}">Liste des courrriers sortants</a></li>
          <li class="breadcrumb-item active">Détails Courier Sortant</li>
        </ol>
      </div><!-- /.col -->
    </div><!-- /.row -->
  </div><!-- /.container-fluid -->
  ...
  <div class="col-md-12">
      ...
      <div class="card">
          <div class="card-header">
              <h4>
                  <a href="{{ url('sortants') }}" id="fileRetour" class="btn btn-danger float-right">Retour</a>
              </h4>
          </div>
                        ...
                        <div class="card card-widget">
                            ...
                            <div class="container">
                                ...
                                <div class="col-md-4">
                                  <table class="invoice-head">
                                    <tbody>
                                      ...
                                      <tr>
                                        <td class="pull-right"><strong>Numéro d’inscription# &nbsp;&nbsp;&nbsp;</strong></td>
                                        <td>{{ $element->numero_inscription }}</td>
                                      </tr>
                                      <tr>
                                        <td class="pull-right"><strong>Date d’édition &nbsp;&nbsp;&nbsp;</strong></td>
                                        <td>{{ $element->date_edition }}</td>
                                      </tr>
                              ...
                              <div class="row">
                                <div class="col-md-12">
                                    <table width="90%">
                                      <tr>
                                        <td width="20%"><b>•	Voie d’envoi</b></td>
                                        <td width="30%">{{ $element->voie_envoi }}</td>
                                      ...
                                      <tr>
                                        <td colspan="1" width="20%"><b>•	Observations </b></td>
                                        <td colspan="3" width="80%">{{ $element->observation }}</td>
                                      </tr>
                                    </table>
                                </div>
                              </div>
                          ...
                          <br><hr><br>
                            @if ($element->piece_jointe)
                              <button id="fileButton" type="button" class="btn btn-default btn-sm"><a href="{{ asset($upload.'/courriers/sortants/'.$element->piece_jointe) }}" target="_blank"><i class="fas fa-share"></i> Fichier</a></button>
                            @else
                                <span></span>
                            @endif
