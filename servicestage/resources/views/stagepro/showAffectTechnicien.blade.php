        ...
        <div class="col-md-12">
            <div class="card" id="invoicepdf" style="margin-left: -3% !important; margin-top: -3% !important;">
                ...
                <div class="invoice-body">
                    ...
                    <div class="col-xs-12">
                        <br>
                            <center class="titreDemande"><h3>A Monsieur le Directeur de : <b>{{ $demand->stage_company }}</b></h3></center>
                    </div>
                    <div class="col-xs-12">                        
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12 content">
                                    ...
                                    <span>Je vous remercie d’avoir bien voulu accepter d’accueillir des stagiaires de l’ISSAT-Gafsa,<br>
                                        et j’ai le plaisir de vous informer que :</span><br>
                                    ...
                                    <span>En vous remerciant de votre bienveillante collaboration, veuillez agréer, Monsieur le <br>
                                        Directeur, l’expression de mes meilleures salutations.</span><br><br>
